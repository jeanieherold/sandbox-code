...
public class StudentController {
	...
	//this method goes to the db and grabs student, puts it in memory and makes it available
	//for the other jsf pages
	public String loadStudent(int studentId) {
		...
		try {
			...
			//helper class to get access to some of the servlet data
			ExternalContext externalContext = 
						FacesContext.getCurrentInstance().getExternalContext();		
			//"student" is the name the JSF page will use to reference this object
			//theStudent is the object we loaded from the db
			//these seeming parameters are actually 'request attributes' 
